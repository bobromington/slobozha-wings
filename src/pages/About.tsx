...
const historyParagraphsEN = [
  ...
  'The history of the airspace cover detachment of the 11th M. Hrushevsky Brigade of the National Guard of Ukraine is an example of consistent development, adaptation to modern challenges, and capability growth in response to the changing nature of threats. It began with the formation of a small unit that initially performed a limited range of tasks, yet even then laid the foundation for future scaling and improvement.',
  'The first stage of formation was an air defense platoon, assembled from the most prepared and motivated servicemen. Its core consisted of mobile fire teams operating within designated areas of responsibility. The main task was to provide cover for critical infrastructure and to monitor and protect the Black Sea coastline from aerial threats. The work was carried out with limited resources, but thanks to high discipline, coordinated action, and rapid response, the unit consistently delivered results.',
  'As experience accumulated and the volume of tasks grew, the structure had to expand. The next stage of development was the reorganization of the platoon into an air defense company. This significantly strengthened personnel capacity, increased the number of mobile fire teams, and broadened the geography of operations. The unit began to act more systematically, with clear distribution of areas of responsibility and well-established command and coordination between elements.',
  'During this period, the foundations of an effective model for countering aerial threats were laid — based on mobility, responsiveness, and constant readiness to react. The unit\'s personnel reliably covered key sites, defended designated sectors, and refined the skills of detecting and destroying targets. The unit gradually became an important element of the overall air defense system in the southern region.',
  'A qualitatively new stage of development began in 2025. That is when the unit received an impetus for active technical and organizational improvement. In response to the changing nature of aerial threats, the first interceptor drone crews were established. This was an important step in transforming the approach to airspace cover.',
  'The introduction of new technologies significantly expanded the unit\'s capabilities. It became possible to act proactively, increase the precision of target detection, and improve strike effectiveness. The crews\' work was complemented by modern aerial surveillance and interception assets, ensuring a comprehensive approach to mission execution.',
  'Given the growth in personnel, expanded functionality, and increased combat capabilities, the decision was made to create the airspace cover detachment. This new organizational level made it possible to unite all elements of the system into a single structure with clear command, interaction, and planning.',
  'The detachment became a multifunctional unit comprising mobile fire teams, UAV interceptor crews, and support and command subunits. This ensured high flexibility in mission execution, the ability to rapidly maneuver forces and assets, and effective response to changes in the situation.',
  'Special attention is paid to personnel training. Servicemen continuously improve their skills, undergo training exercises, and refine cooperation between subunits. This makes it possible to maintain a high level of professional readiness and ensure quality execution of assigned tasks.',
  'As a result of consistent development and the implementation of modern approaches, the airspace cover detachment has achieved significant results. Hundreds of aerial targets have been destroyed across the southern region. These figures testify to the effectiveness of the chosen model, the coordinated work of personnel, and the high level of service organization.',
  'Today, the airspace cover detachment of the 11th M. Hrushevsky Brigade of the National Guard of Ukraine is an important component of the regional security system. It combines experience, modern technology, and the professionalism of its servicemen, allowing it to confidently perform its missions.',
  'The unit continues to evolve. Constant improvement of structure, the introduction of new solutions, and capability growth remain key directions. The detachment continues to provide reliable airspace cover, demonstrating readiness to perform missions in any conditions.',
];
