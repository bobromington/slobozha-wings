...
export const translations = {
  ua: {
    ...
    application: {
      title: 'Анкета',
      subtitle: 'НА ВСТУП ДО ЗАГОНУ «СЛОБОДА»',
      statusLabel: 'Оберіть ваш статус',
      tabs: { civilian: 'Цивільний', military: 'Військовий' },
      fields: {
        firstName: "Ім'я",
        lastName: 'Прізвище',
      ...
      branches: {
        zsu: 'ЗСУ', tro: 'ТрО', ngu: 'НГУ', dpsu: 'ДПСУ',
        mp: 'МП', dshv: 'ДШВ', sso: 'ССО', other: 'Інше',
      },
